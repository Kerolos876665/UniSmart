...
const UserManagement: React.FC = () => {
  ...
  const handleManualSubmit = (e: React.FormEvent) => {
    ...
    setFormData({ name: '', email: '', username: '', role: UserRole.STUDENT });
  };
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="flex gap-4">
                ...
                >
                  ...
                  {isProcessing ? 'جاري التحليل...' : 'توليد الحسابات فوراً'}
                </button>
                <button onClick={() => setShowAIModal(false)} className="px-8 py-4 bg-slate-100 text-slate-600 rounded-2xl font-bold hover:bg-slate-200 transition-all">إلغاء</button>
              </div>
            </div>
          </div>
        </div>
